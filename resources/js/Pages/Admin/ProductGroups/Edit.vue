...
const form = useForm({
    ...
    slug: props.productGroup.slug,
    status: !!props.productGroup.status,
    order_number: props.productGroup.order_number || 0,
    banner: null,
    product_ids: props.productGroup.products.map((p) => p.id),
});

const bannerPreview = ref(props.productGroup.banner);
...
const selectedProducts = ref([...props.productGroup.products]);
...
const submit = () => {
    // We use POST with _method PUT for file uploads in Inertia
    form.post(route("admin.product-groups.update", props.productGroup.id), {
        forceFormData: true,
        onSuccess: () => toast.success("Product group updated successfully"),
    });
};
            ...
            <div class="flex items-center gap-4 mb-8">
                ...
                <div>
                    ...
                    <p class="text-gray-500 dark:text-gray-400 text-sm">
                        Update the group details and products.
                    </p>
                </div>
            </div>
