    ...
    <div class="min-h-screen bg-gray-50 py-8">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div v-if="!cartItems || cartItems.length === 0" class="flex flex-col items-center justify-center py-16">
          <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 sm:p-12 text-center max-w-md w-full">
        ...
        <div v-else class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div class="md:col-span-2 space-y-4">
            ...
            >
              <div class="flex flex-col sm:flex-row gap-4">
                <!-- Product Image -->
                <div class="w-24 h-24 flex-shrink-0 bg-gray-100 rounded-lg overflow-hidden mx-auto sm:mx-0">
                  <img 
                ...
                <!-- Product Details -->
                <div class="flex-1">
                  <h3 class="font-semibold text-gray-900 mb-1 break-words">{{ item.product_name }}</h3>
                  
                  <!-- Variation Attributes -->
                  <div v-if="item.variation_attributes?.length" class="text-sm text-gray-600 mb-2">
                    <span v-for="(attr, idx) in item.variation_attributes" :key="idx">
                      <span class="font-medium">{{ attr.name }}:</span> {{ attr.value }}
                      <span v-if="idx < item.variation_attributes.length - 1">, </span>
                    </span>
                  </div>
                  ...
                  <div class="mt-3 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <div>
                      <p class="text-sm text-gray-600 mb-2">Price: <span class="font-semibold text-gray-900">৳ {{ parseFloat(item.price).toFixed(2) }}</span></p>
                      ...
                      <div class="flex items-center gap-2">
                        ...
                        <button 
                          ...
                          class="w-9 h-9 sm:w-8 sm:h-8 flex items-center justify-center border border-gray-300 rounded hover:bg-gray-100 transition-colors"
                        >
                ...
                <button 
                  ...
                  class="flex-shrink-0 text-red-500 hover:text-red-700 p-3 h-fit self-end sm:self-auto"
                  title="Remove item"
                >
          ...
          <div class="md:col-span-1">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 md:sticky md:top-4">
...
// Get cart data from globally shared Inertia props
const cart = computed(() => page.props.cart?.data || page.props.cart);
